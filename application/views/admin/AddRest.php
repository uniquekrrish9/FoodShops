...
<div class="widget ">
	...
	<div class="widget-content">
		...
		<form role="form" class="form-horizontal" action="<?=Adminpath?>AddRest" method="post" enctype="multipart/form-data">
			<fieldset>
				<!-- <input type="hidden" name="offid" value="<?= (isset($offer_detail) ? $offer_detail->offid : '')?>"> -->
				<div class="control-group">											
					<label class="control-label" for="username">Restaurant Name</label>
					<div class="controls">
						<input type="text" class="span4" id="slider_name" required="true" name="rest_name" />
				...
				<div class="control-group">											
					...
					<div class="controls">
						<textarea class="span4" id="slider_name" required="true" name="rest_address"></textarea>
				...
				<div class="control-group">											
					...
					<div class="controls">
						<input type="text" class="span4" id="slider_name" required="true" name="rest_phone" />
				...
				<div class="control-group">											
					...
					<div class="controls">
						<input type="text" class="span4" id="slider_name" required="true" name="rest_city" />						<p class="help-block"><?=form_error('rest_city')?></p>
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
